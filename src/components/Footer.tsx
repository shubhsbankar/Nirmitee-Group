    ...
    <footer className="relative text-white">
      <div className="bg-[#0b0f39]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20">
          ...
          <div className="grid grid-cols-1 gap-14 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-3 text-white/85">
                ...
                <li><Link href="/media">Media & News</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-4 text-white/85">
                ...
                <li className="flex gap-3">
                  ...
                  <a href="tel:+918007242777">+91 80072 42777</a>
                </li>
                <li className="flex gap-3">
                  <Mail className="h-5 w-5" />
                  <a href="mailto:info@nirmiteegroup.com">
                    info@nirmiteegroup.com
                  </a>
                </li>
              </ul>
          ...
          {/* bottom */}
          <div className="mt-16 border-t border-white/10 pt-8">
            <div className="flex flex-col items-center gap-4 text-sm text-white/70 md:flex-row md:justify-between">
              <p>© {year} Nirmitee Group. All rights reserved.</p>
